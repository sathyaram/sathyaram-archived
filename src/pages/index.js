            ...
            <section className="about">
                <div className="container">
                    <div className="about-me">
                        ...
                        <p>
                            I'm Sathya, a creative front-end developer and web designer in the D.C.
                            area.
                            <br />
                            <br /> I enjoy creating things that live on the internet, whether that
                            be websites, applications, or anything in between. My goal is to always
                            build products that provide pixel-perfect, performant experiences.
                            <br />
                            <br /> After graduating from Lehigh University, I found joy in working
                            with creative web agencies on making custom websites as a web developer
